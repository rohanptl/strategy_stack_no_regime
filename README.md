...
python strategy_stack_no_regime.py   --mode backtest   --universe "./WealthfrontETFs.txt"   --start 2020-01-01   --end 2026-03-01   --top-k 10   --export-prefix wealthfront_no_regime_bt